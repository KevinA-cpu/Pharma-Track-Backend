...
const Search_Province_City = "SELECT * FROM clinic WHERE province = $1 and city = $2";
const Search_Province_City_Adress = "SELECT * FROM clinic WHERE province = $1 and city = $2 and address = $3";

const insertClinic =
  "INSERT INTO clinic (id_clinic,name_clinic,name_doctor,province,city,address,status_clinic) VALUES($1 , $2, $3, $4, $5, $6, $7);";
